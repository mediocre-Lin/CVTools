...
但是它们都多用concat或者element-wise这种融合方式，本论文认为这样不能充分利用不同尺度的特征，
所以提出了Adaptively Spatial Feature Fusion，即自适应特征融合方式
"""
import torch
...
class ASFF(nn.Module):
  ...
  # 尺度大小 level_0 < level_1 < level_2
    ...
    # 自适应融合
        ...
        return out
def conv_bn_relu(in_ch, out_ch, ksize, stride, leaky=True):
    """
