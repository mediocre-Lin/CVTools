"""
@File: anchorAnalyze.py
@Author: Keith 
@Time: 2022/03/30 09:47:59
...
if __name__ == '__main__':
    annFile = 'D:\pixdot\project_camera\glass_defect_data\coco1_camera_defect\\annotations\\instances_train2017.json'
    clusters = 5
